    ...
    return (
        <WrappMPSection>
            ...
            <WrappMPEssence>
              ...
              <WrappMPOneItem
                  onMouseEnter={()=>{setIsActiveEdu3(true)}}
                  onMouseLeave={()=>{setIsActiveEdu3(false)}}
                  presentTime>
                <Circle isActive={isActiveEdu3} presentTime/>
                  <DashFromTheCircle presentTime/>
                  { !showDecorationLine ?
                      <SmallTitleMPOneItem>2020 – 2021</SmallTitleMPOneItem> : null}


                <MPText presentTime> Front-end developer </MPText>
                <MPText presentTime> Nauka i rozwój umiejętności niezbędnych do pracy w zawodzie.</MPText>
                ...
                <ul>
                  ...
                  { showDecorationLine ?
                      <SmallTitleMPOneItem presentTime>2020 – 2021</SmallTitleMPOneItem> : null}
              </WrappMPOneItem>
