...
const NavigationLi = styled.div`
  ...
  width: 100%;
  border-radius: 10px;
  background: ${props => props.isActive ? props.theme.gradients.gradientBox : 'transparent'};
  box-shadow: ${props => props.isActive ? props.theme.shadows.shadowWhite : 'none'};
  color: ${props => props.isActive ? props.theme.colors.colorPrimary : props.theme.colors.colorText};
