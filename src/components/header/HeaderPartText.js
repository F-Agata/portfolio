              ...
              <TypeWrapper>
                <TypeIt
                  getBeforeInit={(instance) => {
                    instance.type('Cześć,').pause(300).type(' jestem <span style="color: #ff014f; font-size: 30px">Agata</span> ').break().type('Moim').pause(300).delete(3).type('ój cel zawodowy,').break().type('to rozwój w kierunku <span style="color: #ff014f; font-size: 28px">Front-end developer </span>');
                    return instance;
                  }}
                />
              </TypeWrapper>
